...
function mapObjectToProperty(obj: any, id: string) {
  ...
  return {
    ...
    totalValue: inv.totalPropertyValue || custom.totalPropertyValue || 0,
    tokenPrice: inv.tokenPricePerShare || custom.tokenPricePerShare || 0,
    yieldPercent: inv.annualYield || custom.annualYield || 0,
    fundedPercent: 100,
    ...
    rentalIncome: fin.monthlyRentalIncome || custom.monthlyRentalIncome,
    expenses: fin.annualExpenses || custom.annualExpenses,
    capRate: fin.capRate || custom.capRate,
    projectedReturn: fin.projectedAppreciation || custom.projectedAppreciation,
    ...
    tokenCount: inv.totalTokens || custom.totalTokens || 1,
